...
好的，這是將前面所有問題的解法整合到一個完整的 C++ 程式碼中。這個程式碼包含了 **變數運算、用戶互動輸入、循環控制和批次數據處理** 等功能，並清晰地標註了對應的**問題編號**。

您可以將這段程式碼複製並存為 `.cpp` 文件（例如 `basic_exercises.cpp`），然後使用 C++ 編譯器（如 g++）進行編譯和執行。

```cpp
#include <iostream>
#include <vector>
#include <cmath>
#include <iomanip> // 用於設置輸出精度 (setprecision)

// 使用 std 命名空間，可以簡化程式碼 (如 cout 代替 std::cout)
using namespace std;

// 程式執行入口點
int main() {
    // 設置輸出格式，讓浮點數顯示更精確，解決問題 1, 2, 3 的除法顯示
    cout << fixed << setprecision(2);

    // =================================================================
    // 問題 1: 數值常數計算 (8*3, 8/3, 8+3)
    // =================================================================
    cout << "=================================================" << endl;
    cout << "【問題 1】: 數值常數計算" << endl;
    double A1, A2, A3;

    A1 = 8 * 3;
    // 使用 8.0 / 3.0 確保執行浮點數除法
    A2 = 8.0 / 3.0;
    A3 = 8 + 3;
    ...
    // =================================================================
    // 問題 2: 使用變數進行運算 (A=8, B=2)
    // =================================================================
    cout << "\n=================================================" << endl;
    cout << "【問題 2】: 使用變數進行運算 (A=8, B=2)" << endl;
    int A = 8;
    int B = 2;
    double B1, B2, B3;

    B1 = A * B;
    // 使用 (double)A / B 進行強制類型轉換
    B2 = (double)A / B;
    B3 = A - B;

    cout << "變數 A=" << A << ", B=" << B << endl;
    cout << "B1 (A * B) = " << B1 << endl;
    cout << "B2 (A / B) = " << B2 << endl;
    cout << "B3 (A - B) = " << B3 << endl;
    ...
    if (InputB != 0) {
        ...
        cout << "\nA * B = " << C1 << endl;
        cout << "A - B = " << C2 << endl;
        cout << "A / B: 錯誤 (除數為零)" << endl;
    }


    // =================================================================
    // 問題 7: 輸出格式控制 (PRINT X 和 X^2) (接著問題 3 執行)
    // =================================================================
    cout << "\n=================================================" << endl;
    cout << "【問題 7】: 計算平方與格式化輸出" << endl;
    double X;
    ...
    cout << "\n輸出結果:" << endl;
    // 使用 Tab (\t) 分隔，模擬 BASIC 的逗號 (,) 分隔欄位
    cout << "X 值\tX^2 值" << endl;
    cout << X << "\t" << Y << endl;


    // =================================================================
    // 問題 4: 重複執行（for 循環 / 模擬 GOTO）
    // =================================================================
    cout << "\n=================================================" << endl;
    cout << "【問題 4】: 連續計算 3 個數目的平方 (for 迴圈)" << endl;
    ...
    // =================================================================
    cout << "\n=================================================" << endl;
    cout << "【問題 5 & 6】: 模擬 READ/DATA 批次處理" << endl;

    // 使用 C++ 向量 (vector) 儲存資料，模擬 DATA 語句
    vector<int> DataA = {3, 4, 5};
    vector<int> DataB = {4, 9, 9};
    ...
    for (size_t i = 0; i < DataA.size(); ++i) {
        ...
        // 使用 \t 模擬表格對齊
        cout << " " << CurrentA << "\t " << CurrentB << "\t " << Result << endl;
    }
    cout << "-----------------------" << endl;
    cout << " (問題 6 說明: 程式 1 和 2 結果相同，因為 C++ 的 vector/array\n"
         << "  數據流也是連續且依序讀取的，與 BASIC 的 DATA 概念一致。)" << endl;
